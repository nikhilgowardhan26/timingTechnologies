...
const stickyObsever = new IntersectionObserver(
  (entriesSticky) => {
...
$(document).ready(function () {
  ...
  function handlehome(input) {
    ...
    switch (input) {
      case "home-tab":
        ...
        $(".trained-h1").text(
          "Our skilled professionals are matter experts in a variety of domains"
        );
        $("#talented_para1, #talented_para2").text(
          "They are talented individuals, problem-solvers, and change-makers who work to sustain and grow in the world of technology."
        );
      ...
      case "profile-tab":
        ...
        $("#talented_para1, #talented_para2").text(
          "Exploring our capabilities only to implement and innovate the best practices, creating/generating opportunities for the best."
        );
      ...
      case "contact-tab":
        ...
        $("#talented_para1, #talented_para2").text(
          "We respect the time and energy they invest in us, so we ultimately work to deliver services of the best quality and meet all their desires. We trust in making them happy and content."
        );
      ...
      case "economical-tab":
        ...
        $(".trained-h1").text(
          "With the increase in the need for technology, it has become unbelievably expensive to get access to quality services."
        );
        $("#talented_para1, #talented_para2").text(
          "Our motto is to make it affordable, maintaining the best quality through cost-effective solutions."
        );
  ...
  function hoverAction(active1Id, other1Id, other2Id, other3Id) {
    ...
    $("#" + other1Id + ", #" + other2Id + ", #" + other3Id).css({
      color: "#ffffff",
      fontWeight: "300",
    });
  }
